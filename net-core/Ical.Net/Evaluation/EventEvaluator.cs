...
namespace Ical.Net.Evaluation
{
    public class EventEvaluator : RecurringEvaluator
    {
        ...
        /// <returns></returns>
        public override HashSet<Period> Evaluate(ImmutableCalDateTime referenceTime, DateTime periodStart, DateTime periodEnd, bool includeReferenceDateInResults)
        {
            ...
            {
                period.Duration = CalendarEvent.DurationSpan;
                period.EndTime = period.Duration == null
                    ? period.StartTime
                    : period.StartTime.Add(CalendarEvent.DurationSpan);
            }
